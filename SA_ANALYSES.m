...
for c_index = 1 : nb_maps
    ...
    for i = 1 : nb_runs
        chaotic_results.(names{c_index}).(function_name){i} = chaotic_simulated_annealing(chaotic_config);
        if c_index == nb_maps
            results.(function_name){i} = simulated_annealing(config);
        end
...
for map_index = 1 : nb_maps
    ...
    for i = 1 : nb_runs
        ...
        fht.(function_name)(i) = results.(function_name){i}.first_hitting_time;
    end
